    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Processing AI'), ('completed', 'Success'), ('failed', 'Failed')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_name', models.CharField(default='modern_minimalist', max_length=100)),
                ('resume_history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='core.resumehistory')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
